...
var instrucciones = ["Usa las flechas del teclado para mover las piezas.", "Intercambia las piezas del lugar para que queden iguales a las del objetivo."];
...
function mostrarInstrucciones(instrucciones) {
  console.log("FUNCION MOSTRAR INSTRUCCIONES");
  let localInstrucciones=instrucciones;
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  // console.log("cambiar" + grilla[filaPos1][columnaPos1] + " por " + grilla[filaPos2][columnaPos2]);
...
function posicionValida(fila, columna) {
    //ver como mejorarlo para que sirva para tamaños de grilla desconocidos
    //ahora no se como chequear las columnas porque si la fila es mayor a la grilla
...
function mostrarCantidadMovimientos() {
  var p = document.getElementById("numeroMovimientos");
  // var li = document.createElement("li");
  p.textContent = cantidadDeMovimientos;
  // ul.appendChild(li);
}
